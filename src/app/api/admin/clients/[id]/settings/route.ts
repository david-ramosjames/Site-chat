...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const widget = {
    ...
    introVideoUrlEs: nullable(rest.introVideoUrlEs),
    introPosterUrlEs: nullable(rest.introPosterUrlEs),
    introVideoEndImageUrlEs: nullable(rest.introVideoEndImageUrlEs),
    introVideoStyle: rest.introVideoStyle,
    bubbleImageUrl: nullable(rest.bubbleImageUrl),
    bubbleTooltip: nullable(rest.bubbleTooltip),
    bubbleTooltipBgColor: nullable(rest.bubbleTooltipBgColor),
    bubbleTooltipTextColor: nullable(rest.bubbleTooltipTextColor),
    ...
    secondWelcomeBgColor: nullable(rest.secondWelcomeBgColor),
    secondWelcomeTextColor: nullable(rest.secondWelcomeTextColor),
    brandingFooterEnabled: rest.brandingFooterEnabled,
    brandingFooterText: nullable(rest.brandingFooterText),
