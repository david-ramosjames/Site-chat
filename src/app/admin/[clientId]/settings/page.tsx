    ...
    <div className="space-y-6">
      ...
      <SettingsForm
        ...
        initial={{
          ...
          introVideoUrlEs: ws?.introVideoUrlEs ?? "",
          introPosterUrlEs: ws?.introPosterUrlEs ?? "",
          introVideoEndImageUrlEs: ws?.introVideoEndImageUrlEs ?? "",
          ...
          signTemplateIdEn: ws?.signTemplateIdEn ?? "",
          signTemplateIdEs: ws?.signTemplateIdEs ?? "",
        }}
      />
    </div>
  );
