...
export default function DemoPage({ searchParams }: { searchParams: { clientId?: string } }) {
  const clientId = searchParams.clientId || DEMO_CLIENT_ID;
  return (
    <main className="mx-auto max-w-3xl space-y-6 px-6 py-16">
      ...
      <p className="text-ink-700">
        The ChatToConvert widget has been injected in the corner of this page. Click the chat
        bubble to walk through the flow as a visitor would. Submissions land in the leads
        dashboard.
      </p>
